import { IShopLocation } from '@AthenaPlugins/gp-shop/shared/interfaces';

export const coreShopLocations: IShopLocation[] = [
    {
        x: 25.980966567993164,
        y: -1345.6417236328125,
        z: 28.497024536132812,
        isBlip: true,
    ...
    {
        x: -3243.743408203125,
        y: 1001.3903198242188,
        z: 11.830706596374512,
        isBlip: true,
        pedModel: 'mp_m_shopkeep_01',
        pedHeading: 90.0,
    },
    {
        x: 548.0447387695312,
        y: 2669.48876953125,
        z: 41.156490325927734,
        isBlip: true,
        pedModel: 'mp_m_shopkeep_01',
        pedHeading: 90.0,
    },
    {
        x: 1960.2322998046875,
        y: 3742.317138671875,
        z: 31.343746185302734,
        isBlip: true,
        pedModel: 'mp_m_shopkeep_01',
        pedHeading: 90.0,
    },
...
export const ltdLocations: IShopLocation[] = [
    ...
    { x: -1820.6717529296875, y: 792.8975219726562, z: 137.11163330078125, isBlip: true },
];
