            ...
            <div class="shopWrapper">
                <div class="shopItem" v-for="(shopItem, index) in filteredItems" :key="index">
                    <div class="item" v-if="ShopSystem.ShopItems">
                        <div class="image">
                            <img :src="ResolvePath(`../../assets/icons/${shopItem.icon}.png`)" id="Images" />
                        </div>
...
import { View_Events_GPShop } from '../shared/events';
...
const ComponentName = Config.shopPageName;
export default defineComponent({
    ...
    mounted() {
        WebViewEvents.on(View_Events_GPShop.CV_SetItems, this.fillShopItems);
    ...
    methods: {
        ...
        buyShopItem(index: number) {
            ...
            WebViewEvents.emitServer(
                View_Events_GPShop.VS_HandleShop,
